...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "DbConnection\0connectionLost\0"
};
...
void DbConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DbConnection::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DbConnection::connectionLost)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DbConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DbConnection.data,
...
// SIGNAL 0
void DbConnection::connectionLost()
{
